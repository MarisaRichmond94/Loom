      ...
      <main className="flex-1">
        <div className="max-w-4xl mx-auto px-6 pt-12 pb-10">
          <div className="flex items-start justify-between gap-6">
            ...
            {/* Disabled until reading progress exists (LOOM-133). Present
                rather than absent so the page has its real shape, and so the
                control's placement is reviewable now. */}
            <button
              disabled
